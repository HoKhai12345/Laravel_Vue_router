                            ...
                            <div class="row">
                                <div class = "col-12">
                                    <form class="ml-2" action="javascript:void(0)" method="get">
                                        ...
                                        <button type="submit" :disabled="processing" @click="getListUser" class="btn btn-primary btn-block">
                                            {{ processing ? "Please wait" : "list user" }}
                                        </button>
                                    </form>
                                </div>
                                <div class="col-12">
...
<script>
    ...
    export default {
        ...
        async getListUser(limit , skip) {
            this.processing = true;
            const form = reactive({
                'username': '',
            })

            const { errors, sendLogin } = useUser()
